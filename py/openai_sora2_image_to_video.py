...
class SFWaveSpeedSora2ImageToVideo:
    """
...
# Node registration
NODE_CLASS_MAPPINGS = {
    "SFWaveSpeedSora2ImageToVideo": SFWaveSpeedSora2ImageToVideo
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "SFWaveSpeedSora2ImageToVideo": "SF WaveSpeed Sora 2 Image to Video"
}
