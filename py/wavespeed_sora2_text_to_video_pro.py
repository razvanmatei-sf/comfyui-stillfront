...
class SFWaveSpeedSora2TextToVideoPro:
    """
...
# Node registration
NODE_CLASS_MAPPINGS = {
    "SFWaveSpeedSora2TextToVideoPro": SFWaveSpeedSora2TextToVideoPro
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "SFWaveSpeedSora2TextToVideoPro": "SF WaveSpeed Sora 2 Text to Video Pro"
}
